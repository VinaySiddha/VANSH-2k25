...
function NailArtAndFaceArt() {
    ...
    useEffect(() => {
        setLoading(true);
        fetch('https://vansh-2k25.onrender.com/api/registrations/by-event/NAIL_ART_AND_FACE_ART')
            .then(response => {
                if (!response.ok) {
    ...
    return (
        <div className="cad-designing-container">
            <h2>Nail Art and Face Art Registrations</h2>
...
export default NailArtAndFaceArt;