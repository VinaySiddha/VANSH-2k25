...
function SingingGroup() {
    ...
    useEffect(() => {
        setLoading(true);
        fetch('https://vansh-2k25.onrender.com/api/registrations/by-event/SINGING_GROUP')
            .then(response => {
                if (!response.ok) {
    ...
    return (
        <div className="cad-designing-container">
            <h2>Group Singing Registrations</h2>
