...
function BattleOfBands() {
    ...
    useEffect(() => {
        setLoading(true);
        fetch('https://vansh-2k25.onrender.com/api/registrations/by-event/BATTLE_OF_BANDS')
            .then(response => {
                if (!response.ok) {
    ...
    return (
        <div className="cad-designing-container">
            <h2>Battle of Bands Registrations</h2>
