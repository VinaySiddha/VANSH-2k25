...
function MrMrsCoders() {
    ...
    useEffect(() => {
        setLoading(true);
        fetch('https://vansh-2k25.onrender.com/api/registrations/by-event/Mr_Mrs_CODERS')
            .then(response => {
                if (!response.ok) {
    ...
    return (
        <div className="cad-designing-container">
            <h2>Mr/Mrs Coders Registrations</h2>
