...
function CodingRelay() {
    ...
    useEffect(() => {
        setLoading(true);
        fetch('https://vansh-2k25.onrender.com/api/registrations/by-event/CODING_RELAY')
            .then(response => {
                if (!response.ok) {
    ...
    return (
        <div className="cad-designing-container">
            <h2>Coding Relay Registrations</h2>
